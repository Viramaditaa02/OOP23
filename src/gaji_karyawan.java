...
public class gaji_karyawan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Jawaban");

        cmb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Karyawan", "Sekertaris", "Maneger", " " }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lembur, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(cmb, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(hadir, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    int lbr = Integer.parseInt(hadir.getText());

    if (cmb.getSelectedIndex() == 0) {
       gaji_karyawan obj1 = new gaji_karyawan();
        int gaji = obj1.hitgaji();
        hasil.setText(Integer.toString(gaji));
    } else if (cmb.getSelectedIndex() == 1) {
       gajisekertaris  obj2 = new gajisekertaris();
        int gaji = obj2.hitgaji(hdr);
        hasil.setText(Integer.toString(gaji));
    } else {
        gajimaneger obj3 = new gajimaneger();
        int gaji = obj3.hitgaji(hdr, lbr);
        hasil.setText(Integer.toString(gaji));
    }        
